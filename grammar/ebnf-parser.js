...
function tokenizeEBNF(source) {
    ...
    while (pos < source.length) {
        ...
        switch (ch) {
            case '=':
                tokens.push({ kind: 'EQUALS', value: ch, line });
                break;
            case '|':
                tokens.push({ kind: 'PIPE', value: ch, line });
                break;
            case ';':
                tokens.push({ kind: 'SEMICOLON', value: ch, line });
                break;
            case '(':
                tokens.push({ kind: 'LPAREN', value: ch, line });
                break;
            case ')':
                tokens.push({ kind: 'RPAREN', value: ch, line });
                break;
            case '[':
                tokens.push({ kind: 'LBRACKET', value: ch, line });
                break;
            case ']':
                tokens.push({ kind: 'RBRACKET', value: ch, line });
                break;
            case '{':
                tokens.push({ kind: 'LBRACE', value: ch, line });
                break;
            case '}':
                tokens.push({ kind: 'RBRACE', value: ch, line });
                break;
